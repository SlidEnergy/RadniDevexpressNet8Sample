...
{
    /// <summary>
    /// Criteria that constrains a property to be null.
    /// </summary>
    [Serializable]
    public class NullCriteria : FilterCriteria, IPropertyCriteria
    {
        const String ToFormatString = "[{0} is NULL]";

        /// <summary>
        /// Initializes instance of <see cref="NotNullCriteria"/>.
        /// </summary>
        /// <param name="propertyName">The name of the constrainted property.</param>
        public NullCriteria(String propertyName)
        {
